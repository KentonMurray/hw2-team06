...
public class ShuHaoBioPassageExtractor extends SimplePassageExtractor {
...
//        String text = Jsoup.parse(htmlText).text().replaceAll("([\177-\377\0-\32]*)", "")/* .trim() */;
        ...
        ShuHaoPassageCanditateFinder finder = new ShuHaoPassageCanditateFinder(id, text,
                new ShuHaoKeytermWindowScorerSum());
